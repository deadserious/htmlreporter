...
uses
  ...
  StdCtrls, ExtCtrls, uSearchTextForm;
...
function TfrmTextReplace.GetReplaceText: string;
begin
  Result := cbReplaceText.Text;
end;

function TfrmTextReplace.GetReplaceTextHistory: string;
var
  i: integer;
begin
  Result := '';
...
procedure TfrmTextReplace.SetReplaceText(Value: string);
begin
  cbReplaceText.Text := Value;
end;

procedure TfrmTextReplace.SetReplaceTextHistory(Value: string);
begin
  cbReplaceText.Items.Text := Value;
end;

procedure TfrmTextReplace.FormCloseQuery(Sender: TObject;
