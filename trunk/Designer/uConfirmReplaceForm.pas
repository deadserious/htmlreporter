...
type
  TfrmConfirmReplace = class(TForm)
    btnReplace: TButton;
...
var
  frmConfirmReplace: TfrmConfirmReplace;
...
procedure TfrmConfirmReplace.FormCreate(Sender: TObject);
begin
  Image1.Picture.Icon.Handle := LoadIcon(0, IDI_QUESTION);
end;

procedure TfrmConfirmReplace.FormDestroy(Sender: TObject);
begin
  frmConfirmReplace := nil;
end;

procedure TfrmConfirmReplace.PrepareShow(AEditorRect: TRect;
